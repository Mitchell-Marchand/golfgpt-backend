...
router.post("/create", authenticateUser, async (req, res) => {
    ...
    try {
        ...
        - "questions" (array): list of all additional per-hole questions (past tense) required to accurately score the match based on the rules. Include proximity (closest to the hole not just on par 3s) if relevant for formats like Scotch. Format each question as: 
          {
            "question": "string",
