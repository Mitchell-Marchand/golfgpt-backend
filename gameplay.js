...
router.post("/create", authenticateUser, async (req, res) => {
    ...
    try {
        ...
        - "scorecards": one per golfer, with name, tees, handicap (if unknown put 0), and 18 holes. Each hole includes: holeNumber, par, yardage, allocation, and strokes (calculated based on the allocation of the hole and the golfer's handicap, if known - otherwise 0).
