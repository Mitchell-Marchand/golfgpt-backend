...
router.post("/create", authenticateUser, async (req, res) => {
    ...
    try {
        ...
        - "scorecards": one per golfer, with name, tees, handicap (if unknown put 0), and 18 holes. Each hole includes: holeNumber, par, yardage, allocation, and strokes (calculated based on the allocation of the hole, the golfer's handicap (how many strokes they get, unless playing off the low), and the rules, if known - otherwise 0).
